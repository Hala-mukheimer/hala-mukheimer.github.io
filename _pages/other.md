...
<div style="column-count: 3; column-gap: 15px; margin-top: 20px; margin-bottom: 25px;">
  ...
  <div style="break-inside: avoid; margin-bottom: 15px;">
    <img src="/images/hphoto10.jpeg" alt="Photo 11" style="width: 100%; border-radius: 8px; display: block;" />
  </div>
  <div style="break-inside: avoid; margin-bottom: 15px;">
    <img src="/images/vphoto7.jpeg" alt="Photo 12" style="width: 100%; border-radius: 8px; display: block;" />
  </div>
  <div style="break-inside: avoid; margin-bottom: 15px;">
  ...
  <div style="break-inside: avoid; margin-bottom: 15px;">
    <img src="/images/hphoto6.jpeg" alt="Photo 17" style="width: 100%; border-radius: 8px; display: block;" />
  </div>
  <div style="break-inside: avoid; margin-bottom: 15px;">
    <img src="/images/vphoto8.jpeg" alt="Photo 18" style="width: 100%; border-radius: 8px; display: block;" />
  </div>
  <div style="break-inside: avoid; margin-bottom: 15px;">
    <img src="/images/hphoto5.jpeg" alt="Photo 20" style="width: 100%; border-radius: 8px; display: block;" />
  </div>
</div>
